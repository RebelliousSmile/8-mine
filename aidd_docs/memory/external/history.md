...
✅ **Emma — cousinage et histoire commune.** Tranché 2026-05-21 : cousines **germaines** (sang fort) mais **éloignement vécu** par brouille familiale ancienne ayant coupé les deux branches dans leur enfance. Peu de souvenirs partagés robustes. **Reconnexion adulte tardive** — Julien a été le catalyseur (rencontré par Emma lors d'un événement familial où les deux cousines se sont enfin reparlé), ce qui fait de lui presque l'unique événement adulte partagé avant Saint-Michel. L'appel d'Emma = réparation de la brouille. **A2-romance-emma = fusion-confusion non consommée** : pas un arc de drague (cf. nouvelle design-rule `pool-romance-pas-drague`). Le non-franchissement est cognitif (« ce n'est pas ça, tu es ma moitié biographique »), pas moral. Aucune variante FIN-E Emma — les fins Emma sont fraternelles (pacte scellé, sacrifice FIN-C, rupture).

✅ **Pool A2-romance n'est pas un menu de drague.** Tranché 2026-05-21 : initiative variable (PNJ ou Margot), motivation variable (attirance / calcul / désamorçage / besoin affectif), lisibilité variable (geste ambigu, jamais étiqueté), aboutissement non garanti. Cf. design-rule `pool-romance-pas-drague.md`. Conséquence transversale : aucun écran ni dialogue ne présente une liste « choisis ton partenaire ».
